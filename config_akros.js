...
var init_phones = [""],                             // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      watermark_text = "Akros",                 // Optional. Watermark appears behind graphs
      watermark_text2 = "akros-graph.github.io",
      watermark_image_url = "img/akroslogo.png",   // Optional. If image file is in same directory as config, can be just the filename
      page_title = "Akros",                     // Optional. Appended to the page title if share URLs are enabled
...
let headerLogoText = "Dung Le",
headerLinks = [
// {
//     name: "GitHub",
//     url: "https://github.com/akros-graph/akros-graph.github.io"
// },
// {
//     name: "Head-Fi",
//     url: "https://www.head-fi.org/members/vandung2510.566361/"
// },
// {
//     name: "Youtube",
//     url: "https://www.youtube.com/@akros9333"
// }
];
...
d3.json('config_akros.json').then(function(mycfg){
